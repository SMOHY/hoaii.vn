...
namespace Hoaii.Infrastructure.Migrations
{
    ...
    [Migration("20260820183755_VideoAnhDichVuVaTaiLieuDaiLy")]
    partial class VideoAnhDichVuVaTaiLieuDaiLy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hoaii.Domain.Entities.CategoryHeroSlide", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hoaii.Domain.Entities.MegaMenuCuratedItem", b =>
                {
                    ...
                    b.HasIndex("PanelKey", "ColumnKey", "ProductId")
                        .IsUnique();

                    b.HasIndex("PanelKey", "ColumnKey", "SortOrder");

                    b.ToTable("MegaMenuCuratedItems");
                });
            ...
            modelBuilder.Entity("Hoaii.Domain.Entities.RelatedProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hoaii.Domain.Entities.RelatedProduct", b =>
                {
                    ...
                    b.HasOne("Hoaii.Domain.Entities.Product", "RelatedTo")
                        .WithMany()
